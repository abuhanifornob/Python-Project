...
l2 = tk.Label(window, font=("Arial", 14), text="Enter your birthday which includes the day-month-year.", fg="black",
              bg="#F7DC6F")
...
t1 = tk.Text(window, width=20, height=0, state="disabled")
